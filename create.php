...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
  <style>
    ...
    input,select{width:100%;padding:8px;margin-top:4px;border-radius:3px;}
    .btn{padding:8px 12px;border:1px solid #999;border-radius:10px;text-decoration:none}
    .alert{padding:10px;border-radius:30px;margin:10px 0}
...
<body>
  ...
  <form method="post">
    ...
    <label>Email (opsional)
      <input name="email" value="<?= htmlspecialchars($email) ?>" placeholder="nama@gmail.com">
    </label>
