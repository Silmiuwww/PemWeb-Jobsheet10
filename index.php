  ...
  <table>
    <thead>
      <tr>
        ...
        <td class="table-primary">Dibuat</td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="row-actions">
          <a class="btn btn-warning btn-sm text-dark" href="edit.php?id=<?= urlencode($r['id']) ?>">Ubah</a>
          <!-- <form action="delete.php" method="post" style="display:inline" onsubmit="return confirm('Hapus data ini?');">
            <input type="hidden" name="id" value="<?= htmlspecialchars($r['id']) ?>">
            <button class="btn" type="submit">Hapus</button>
          </form> -->
          <a href="#" class="btn btn-danger btn-sm text-white" onclick="if(confirm('Hapus data ini?')) { 
